...
return (new CustomEvent(event_name,(function (){var obj36658 = {"detail":data};
return obj36658;
})()));
} else {
...
var f = (function (){var pred__36665 = cljs.core._EQ_;
var expr__36666 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36665.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36666))){
return ((function (pred__36665,expr__36666){
return (function (p1__36659_SHARP_){
return console.warn(p1__36659_SHARP_);
});
;})(pred__36665,expr__36666))
} else {
if(cljs.core.truth_(pred__36665.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36666))){
return ((function (pred__36665,expr__36666){
return (function (p1__36660_SHARP_){
return console.debug(p1__36660_SHARP_);
});
;})(pred__36665,expr__36666))
} else {
if(cljs.core.truth_(pred__36665.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36666))){
return ((function (pred__36665,expr__36666){
return (function (p1__36661_SHARP_){
return console.error(p1__36661_SHARP_);
});
;})(pred__36665,expr__36666))
} else {
return ((function (pred__36665,expr__36666){
return (function (p1__36662_SHARP_){
return console.log(p1__36662_SHARP_);
});
;})(pred__36665,expr__36666))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36669){
...
var opts = map__36670__$1;
var eval_fn = cljs.core.get.call(null,map__36670__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36672_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36674,(0),null);
var v = cljs.core.nth.call(null,vec__36674,(1),null);
...
}catch (e36679){if((e36679 instanceof Error)){
var e = e36679;
return not_found;
} else {
throw e36679;
...
//# sourceMappingURL=utils.js.map?rel=1508469657512
