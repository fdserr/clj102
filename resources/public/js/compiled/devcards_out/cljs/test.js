...
var G__38629 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__38629,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__38629;
}
});
...
var or__30048__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__31325__auto___38634 = arguments.length;
var i__31326__auto___38635 = (0);
while(true){
if((i__31326__auto___38635 < len__31325__auto___38634)){
args__31332__auto__.push((arguments[i__31326__auto___38635]));

var G__38636 = (i__31326__auto___38635 + (1));
i__31326__auto___38635 = G__38636;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31333__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38631){
var G__38632 = cljs.core.first.call(null,seq38631);
var seq38631__$1 = cljs.core.next.call(null,seq38631);
var G__38633 = cljs.core.first.call(null,seq38631__$1);
var seq38631__$2 = cljs.core.next.call(null,seq38631__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38632,G__38633,seq38631__$2);
});
...
var file = cljs.core.get.call(null,map__38638__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38638__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38638__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__38638,map__38638__$1,file,line,column){
return (function (p1__38637_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__38637_SHARP_));
});})(map__38638,map__38638__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__31101__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__31101__auto__,prefer_table__31102__auto__,method_cache__31103__auto__,cached_hierarchy__31104__auto__,hierarchy__31105__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__30048__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
...
var temp__5278__auto___38640 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5278__auto___38640)){
var message_38641 = temp__5278__auto___38640;
cljs.core.println.call(null,message_38641);
} else {
}
...
var temp__5278__auto___38642 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5278__auto___38642)){
var message_38643 = temp__5278__auto___38642;
cljs.core.println.call(null,message_38643);
} else {
}
...
var output_dir = "resources/public/js/compiled/devcards_out";
var output_dir__$1 = (function (){var G__38644 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38644),"/"].join('');
} else {
return G__38644;
}
})();
...
var temp__5276__auto__ = (function (){var and__30036__auto__ = typeof exception.stack === 'string';
if(and__30036__auto__){
var G__38646 = exception.stack;
var G__38646__$1 = (((G__38646 == null))?null:clojure.string.split_lines.call(null,G__38646));
var G__38646__$2 = (((G__38646__$1 == null))?null:cljs.core.get.call(null,G__38646__$1,depth));
if((G__38646__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__38646__$2);
}
} else {
...
var vec__38647 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__38647,(0),null);
var column = cljs.core.nth.call(null,vec__38647,(1),null);
var vec__38650 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__38650,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__38650,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__38650,(2),null);
...
var m__$1 = (function (){var G__38653 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__38657 = (function (){var G__38656 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__38656);
} else {
return G__38656;
}
})();
...
return cljs.core.vary_meta.call(null,G__38658,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e38659){var e = e38659;
var G__38660 = e;
var G__38660__$1 = (((G__38660 instanceof cljs.core.Keyword))?G__38660.fqn:null);
switch (G__38660__$1) {
...
var vec__38662 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__38662,(0),null);
var types = vec__38662;
...
return cljs.core.map.call(null,(function (p__38665){
var vec__38666 = p__38665;
var ns = cljs.core.nth.call(null,vec__38666,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__38666,(1),null);
return ((function (vec__38666,ns,vars__$1){
return (function (){
...
var G__38669 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__38669__$1 = (((G__38669 instanceof cljs.core.Keyword))?G__38669.fqn:null);
switch (G__38669__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1){
return (function (){
var seq__38670 = cljs.core.seq.call(null,vars__$1);
var chunk__38671 = null;
var count__38672 = (0);
var i__38673 = (0);
while(true){
if((i__38673 < count__38672)){
var v = cljs.core._nth.call(null,chunk__38671,i__38673);
var temp__5278__auto___38675 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5278__auto___38675)){
var t_38676 = temp__5278__auto___38675;
each_fixture_fn.call(null,((function (seq__38670,chunk__38671,count__38672,i__38673,t_38676,temp__5278__auto___38675,v,each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38676)));
});})(seq__38670,chunk__38671,count__38672,i__38673,t_38676,temp__5278__auto___38675,v,each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1))
);
} else {
}

var G__38677 = seq__38670;
var G__38678 = chunk__38671;
var G__38679 = count__38672;
var G__38680 = (i__38673 + (1));
seq__38670 = G__38677;
chunk__38671 = G__38678;
count__38672 = G__38679;
i__38673 = G__38680;
continue;
} else {
var temp__5278__auto__ = cljs.core.seq.call(null,seq__38670);
if(temp__5278__auto__){
var seq__38670__$1 = temp__5278__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__38670__$1)){
var c__30979__auto__ = cljs.core.chunk_first.call(null,seq__38670__$1);
var G__38681 = cljs.core.chunk_rest.call(null,seq__38670__$1);
var G__38682 = c__30979__auto__;
var G__38683 = cljs.core.count.call(null,c__30979__auto__);
var G__38684 = (0);
seq__38670 = G__38681;
chunk__38671 = G__38682;
count__38672 = G__38683;
i__38673 = G__38684;
continue;
} else {
var v = cljs.core.first.call(null,seq__38670__$1);
var temp__5278__auto___38685__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5278__auto___38685__$1)){
var t_38686 = temp__5278__auto___38685__$1;
each_fixture_fn.call(null,((function (seq__38670,chunk__38671,count__38672,i__38673,t_38686,temp__5278__auto___38685__$1,v,seq__38670__$1,temp__5278__auto__,each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38686)));
});})(seq__38670,chunk__38671,count__38672,i__38673,t_38686,temp__5278__auto___38685__$1,v,seq__38670__$1,temp__5278__auto__,each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1))
);
} else {
}

var G__38687 = cljs.core.next.call(null,seq__38670__$1);
var G__38688 = null;
var G__38689 = (0);
var G__38690 = (0);
seq__38670 = G__38687;
chunk__38671 = G__38688;
count__38672 = G__38689;
i__38673 = G__38690;
continue;
}
} else {
...
});})(each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1))
);
});})(each_fixture_fn,G__38669,G__38669__$1,env,once_fixtures,each_fixtures,vec__38666,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38669__$1)].join('')));

}
})());
});
;})(vec__38666,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1508469659563
