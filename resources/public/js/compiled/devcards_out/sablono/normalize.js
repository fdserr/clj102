...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__37366){
var vec__37367 = p__37366;
var _ = cljs.core.nth.call(null,vec__37367,(0),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__37370_SHARP_){
return ((p1__37370_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__37370_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__37371,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__37371;
}
});
...
var len__31325__auto___37374 = arguments.length;
var i__31326__auto___37375 = (0);
while(true){
if((i__31326__auto___37375 < len__31325__auto___37374)){
args__31332__auto__.push((arguments[i__31326__auto___37375]));

var G__37376 = (i__31326__auto___37375 + (1));
i__31326__auto___37375 = G__37376;
continue;
} else {
}
break;
...
var G__37373 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__37373,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__37373;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq37372){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37372));
});
...
var tag_name = cljs.core.nth.call(null,vec__37379,(0),null);
var names = cljs.core.nth.call(null,vec__37379,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__37379,tag_name,names){
return (function (p1__37377_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__37377_SHARP_))){
return p1__37377_SHARP_;
} else {
return null;
}
});})(matches,vec__37379,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__37379,tag_name,names){
return (function (p1__37378_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__37378_SHARP_));
});})(matches,vec__37379,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__37382){
...
var tag = first__37385;
var content = seq__37384__$1;
...
var vec__37386 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__37386,(0),null);
var id = cljs.core.nth.call(null,vec__37386,(1),null);
var class$ = cljs.core.nth.call(null,vec__37386,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1508469658122
