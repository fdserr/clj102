...
document.write("<script>if (typeof goog != \"undefined\") { goog.require(\"figwheel.connect.build_devcards\"); }</script>");
document.write('<script>goog.require("clj102.core");</script>');